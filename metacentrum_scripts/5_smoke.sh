...
qsub -v "args=\"$data_args --patience 5 --model cdil --optuna_study SD-optuna-smoke4-metacentrum-$dataset --aggregate_runs 2 --optuna_timeout 600 --optuna_params mode@categorical@detection_only,shared_bottleneck,separate_bottleneck hidden_size@int@50@70\"" 1_run_instance.sh
